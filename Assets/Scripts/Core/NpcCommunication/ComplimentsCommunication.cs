...
{
    public class ComplimentsCommunication : Communication<ComplimentsSettings, ReactionsSettings>
    {
        public ComplimentsCommunication(ComplimentsSettings communicationSettings, ReactionsSettings reactionSettings)
