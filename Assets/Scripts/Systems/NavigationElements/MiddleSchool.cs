...
{
    public class MiddleSchool : IEcsInitSystem, INavigationElement
    {
        ...
        public void Init()
        {
            ...
            {
                {NavigationElementType.CurrentOccupationScreen, LocalizationDictionary.GetLocalizedString("occupation_middle_school_screen_btn_title")},
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_middle_school_profile_btn_title")},
            ...
            {
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_middle_school_profile_btn_descr")},
        ...
        public bool CanDisplay(NavigationElementType elementType)
        {
                ...
                elementType == NavigationElementType.SchoolSkip)
            {
                foreach (var i in _charactersFilter)
                {
                    ...
                    if (educationService.Type == EducationType.MiddleSchool)
                    {
                        return true;
                    }
                }
                ...
                case NavigationElementType.CurrentOccupationProfile:
                {
                    foreach (var i in _charactersFilter)
                    {
                        ...
                        _world.NewEntity().Replace(new ShowPopup
                        {
                            ...
                            {
                                IsSchool = true,
                                OrganizationNameText = LocalizationDictionary.GetLocalizedString("occupation_middle_school"),
                ...
                case NavigationElementType.SchoolStudyHarder:
                    {
                        foreach (var i in _charactersFilter)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    HeaderText = _popupHeaders[elementType],
                                    ContentText = LocalizationDictionary.GetLocalizedString("occupation_study_harder_pp"),
                                    ActionsSettings = new List<ActionButtonSettings>
                                    {
                                        new ActionButtonSettings
                                        {
