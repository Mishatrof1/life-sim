...
{
    public class ElementarySchool : IEcsInitSystem, INavigationElement
    {
        ...
        public void Init()
        {
            ...
            {
                {NavigationElementType.CurrentOccupationScreen, LocalizationDictionary.GetLocalizedString("occupation_elementary_school_screen_btn_title")},
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_elementary_school_profile_btn_title")},
            ...
            {
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_elementary_school_profile_btn_descr")},
                ...
                case NavigationElementType.CurrentOccupationProfile:
                {
                    foreach (var i in _charactersFilter)
                    {
                        ...
                        _world.NewEntity().Replace(new ShowPopup
                        {
                            ...
                            {
                                IsSchool = true,
                                OrganizationNameText = LocalizationDictionary.GetLocalizedString("occupation_elementary_school"),
                                SchoolYearsLeftText = (5 - yearsInOrganization).ToString(),
