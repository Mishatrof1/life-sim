...
{
    public class AskOutNpcActivity : IEcsInitSystem, INavigationElement
    {
        ...
        private AskOutSettings _askOutSettings;
        ...
        {
            NavigationElementType.AskOutInteraction
        };
            ...
            foreach (var i in _characterFilter)
            {
                _world.NewEntity()
                    .Replace(new Components.NpcCommunication
                    {
                        ...
                        Character = _characterFilter.Get1(i).Character,
                        Communication = new AskOutCommunication(_askOutSettings, _reactionsSettings)
                    })
                    .Replace(new New());
            }
            return true;
