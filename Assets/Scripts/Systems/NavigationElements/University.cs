...
{
    public class University : IEcsInitSystem, INavigationElement
    {
        ...
        public void Init()
        {
            ...
            _popupHeaders = new Dictionary<NavigationElementType, string>
            {
                ...
                {NavigationElementType.SchoolFaculty, LocalizationDictionary.GetLocalizedString("occupation_university_faculty_pp_header")},
                {NavigationElementType.SchoolNurse, LocalizationDictionary.GetLocalizedString("occupation_university_nurse_pp_header")},
                {NavigationElementType.SchoolLibrary, LocalizationDictionary.GetLocalizedString("occupation_university_library_pp_header")},
                {NavigationElementType.SchoolAdministration, LocalizationDictionary.GetLocalizedString("occupation_university_administration_pp_header")},
            ...
            {
                {NavigationElementType.SchoolDropOut, LocalizationDictionary.GetLocalizedString("occupation_university_drop_out_pp")},
            ...
            {
                {NavigationElementType.CurrentOccupationScreen, LocalizationDictionary.GetLocalizedString("occupation_university_screen_btn_title")},
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_university_profile_btn_title")},
            ...
            {
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_university_profile_btn_descr")},
                ...
                case NavigationElementType.CurrentOccupationProfile:
                {
                    foreach (var i in _charactersFilter)
                    {
                        ...
                        _world.NewEntity().Replace(new ShowPopup
                        {
                            ...
                            {
                                IsSchool = true,
                                OrganizationNameText = LocalizationDictionary.GetLocalizedString("occupation_university"),
