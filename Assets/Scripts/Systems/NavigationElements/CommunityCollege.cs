...
{
    public class CommunityCollege : IEcsInitSystem, INavigationElement
    {
        ...
        public void Init()
        {
            ...
            _popupHeaders = new Dictionary<NavigationElementType, string>
            {
                ...
                {NavigationElementType.SchoolFaculty, LocalizationDictionary.GetLocalizedString("occupation_college_faculty_pp_header")},
                {NavigationElementType.SchoolNurse, LocalizationDictionary.GetLocalizedString("occupation_college_nurse_pp_header")},
                {NavigationElementType.SchoolLibrary, LocalizationDictionary.GetLocalizedString("occupation_college_library_pp_header")},
                {NavigationElementType.SchoolAdministration, LocalizationDictionary.GetLocalizedString("occupation_college_administration_pp_header")},
            ...
            {
                {NavigationElementType.SchoolDropOut, LocalizationDictionary.GetLocalizedString("occupation_college_drop_out_pp")},
            ...
            {
                {NavigationElementType.CurrentOccupationScreen, LocalizationDictionary.GetLocalizedString("occupation_college_screen_btn_title")},
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_college_profile_btn_title")},
            ...
            {
                {NavigationElementType.CurrentOccupationProfile, LocalizationDictionary.GetLocalizedString("occupation_college_profile_btn_descr")},
        ...
        public bool CanDisplay(NavigationElementType elementType)
        {
                ...
                elementType == NavigationElementType.SchoolSkip)
            {
                foreach (var i in _charactersFilter)
                {
                    ...
                    if (educationService.Type == EducationType.CommunityCollege)
                    {
                        return true;
                    }
                }
                ...
                case NavigationElementType.CurrentOccupationProfile:
                {
                    foreach (var i in _charactersFilter)
                    {
                        ...
                        var timeLeft = WorldDateModule.CurrentDate -
                                       character.OccupationHistory[currentOccupation].StartDate;
                        ...
                        _world.NewEntity().Replace(new ShowPopup
                        {
                            ...
                            {
                                IsSchool = true,
                                OrganizationNameText = LocalizationDictionary.GetLocalizedString("occupation_college"),
                                SchoolYearsLeftText = (WorldDate.FromMonths(educationService.DurationMonths) - timeLeft).TotalYears.ToString(),
                                GradesSliderValue = educationService.Productivity * 0.01f,
        ...
        public NavigationButtonData GetButtonData(NavigationElementType elementType)
        {
            ...
            if (_buttonTitles.TryGetValue(elementType, out var title))
            {
                buttonData.Title = title;
            }
            
            if (_buttonDescriptions.TryGetValue(elementType, out var description))
            {
